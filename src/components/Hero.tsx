...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 relative overflow-hidden">
      <div className="absolute inset-0 z-0 bg-gradient-to-tr from-[#00f0ff] to-black opacity-60"></div>
      ...
      <div className="z-10 space-y-6">
        <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-600 animate-pulse drop-shadow-lg">
          Bem-vindo à CRSET Solutions
        </h1>
        <p className="max-w-xl text-gray-400 text-lg md:text-xl">
          Construímos soluções inteligentes com automação, estratégias orientadas por dados e inovação de nível quântico.
        </p>
        <a
          href="#solutions"
          className="mt-6 inline-block px-6 py-3 border border-cyan-500 rounded-full text-cyan-300 hover:bg-cyan-500 hover:text-black transition"
        >
          Explorar Soluções
        </a>
      </div>
